...
{ imports =
  ...
  networking.hostName = "nixde"; # Define your hostname.
  ...
  i18n.extraLocaleSettings = { LC_ADDRESS = "zh_CN.UTF-8"; LC_IDENTIFICATION = "zh_CN.UTF-8"; LC_MEASUREMENT = "zh_CN.UTF-8"; LC_MONETARY = 
    "zh_CN.UTF-8"; LC_NAME = "zh_CN.UTF-8"; LC_NUMERIC = "zh_CN.UTF-8"; LC_PAPER = "zh_CN.UTF-8"; LC_TELEPHONE = "zh_CN.UTF-8"; LC_TIME = 
    "zh_CN.UTF-8";
  };
  ...
  users.users.harry = { isNormalUser = true; description = "harry"; extraGroups = [ "networkmanager" "wheel" ]; packages = with pkgs; [
      kdePackages.kate
    ];
  };
  ...
  # Open ports in the firewall. networking.firewall.allowedTCPPorts = [ ... ]; networking.firewall.allowedUDPPorts = [ ... ]; Or disable the 
